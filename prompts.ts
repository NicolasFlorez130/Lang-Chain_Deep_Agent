...
export const FILE_USAGE_INSTRUCTIONS = `
...
export const SUMMARIZE_WEB_SEARCH = (webpage_content: string, date: string) => `
...
export const RESEARCHER_INSTRUCTIONS = (date: string) => `
